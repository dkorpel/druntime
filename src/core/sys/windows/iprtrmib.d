...
struct MIB_IPADDRTABLE {
    ...
    MIB_IPADDRROW* table() return @nogc nothrow { return _table.ptr; }
}
...
struct MIB_IPFORWARDTABLE {
    ...
    MIB_IPFORWARDROW* table() return @nogc nothrow { return _table.ptr; }
}
...
struct MIB_IPNETTABLE {
    ...
    MIB_IPNETROW* table() return @nogc nothrow { return _table.ptr; }
}
...
struct MIB_IFTABLE {
    ...
    MIB_IFROW* table() return @nogc nothrow { return _table.ptr; }
}
...
struct MIB_TCPTABLE {
    ...
    MIB_TCPROW* table() return @nogc nothrow { return _table.ptr; }
}
...
struct MIB_UDPTABLE {
    ...
    MIB_UDPROW* table() return @nogc nothrow { return _table.ptr; }
}
